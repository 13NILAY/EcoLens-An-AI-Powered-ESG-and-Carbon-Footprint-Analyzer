          ...
          <Link to="/">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">Investor Portal</div>
              </div>
            </div>
          </Link>
          <button 
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-gray-900 truncate">Investor Account</div>
              <div className="text-xs text-gray-500">Premium Analytics</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  {navigation.find(item => isActive(item.href))?.name || 'ESG Dashboard'}
                </h1>
                <p className="text-sm text-gray-500">
                  Advanced ESG analytics for sustainable investing
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-500">analyst@greenfund.com</div>
                </div>
